...
structure. In this vignette, we focus on how to use `hashprng::hash_seed` only.
For different phenomena, questions, and models, researchers will need to
identify and implement the appropriate matching. Indeed, some questions do not
call for matching.
...
Throughout this vignette we consider a few matching regimes:
 ...
 them. Note: this kind of simulation should still be seeded, to enable
 reproducible PRNG.
...
Hash-based matched (HBM) PRNG is an approach to achieving FEM simulations. There
